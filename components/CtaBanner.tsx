...
export default function CtaBanner() {
  ...
  return (
    <section ref={ref} className="px-12 max-sm:px-5">
      <div
        className="max-w-site mx-auto bg-zinc-900 rounded-card p-16 grid grid-cols-[1fr_auto] gap-12 items-center relative overflow-hidden max-lg:grid-cols-1 max-lg:text-center max-lg:p-12 max-lg:px-8 max-sm:p-10 max-sm:px-6"
        style={{
          opacity: visible ? 1 : 0,
      ...
      >
        ...
        <Link
          href="#contact"
          className="relative z-10 bg-emerald-500 text-white px-9 py-4 rounded-btn text-[15px] font-semibold tracking-[-0.2px] whitespace-nowrap shrink-0 hover:bg-emerald-600 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-400 ease-smooth animate-[cta-glow_3s_ease-in-out_infinite]"
        >
          Book a Free Call
        </Link>
      </div>
